...
vim.g.zipPlugin_ext =
'*.nupkg,*.aar,*.apk,*.celzip,*.crtx,*.docm,*.docx,*.dotm,*.dotx,*.ear,*.epub,*.gcsx,*.glox,*.gqsx,*.ja,*.jar,*.kmz,*.odb,*.odc,*.odf,*.odg,*.odi,*.odm,*.odp,*.ods,*.odt,*.otc,*.otf,*.otg,*.oth,*.oti,*.otp,*.ots,*.ott,*.oxt,*.potm,*.potx,*.ppam,*.ppsm,*.ppsx,*.pptm,*.pptx,*.sldx,*.thmx,*.vdw,*.war,*.wsz,*.xap,*.xlam,*.xlsb,*.xlsm,*.xlsx,*.xltm,*.xltx,*.xpi,*.zip'


local fzf_path = "/opt/homebrew/opt/fzf"
vim.opt.rtp:prepend(fzf_path)
...
-- proxy setup for copilot
-- vim.env.http_proxy = "http://127.0.0.1:9080"
-- vim.env.https_proxy = "http://127.0.0.1:9080"
      ...
      require('onedark').load()
        ...
        -- Promela & Spin
        {
			...
			on_attach = function(client, bufnr)
			        vim.keymap.set("n", "<leader>f", "<cmd>FormatPml<CR>")
		        end,
                }
        },
        --{
...
vim.api.nvim_exec([[
  command! FormatPml execute ":%!python3 ~/.config/nvim/custom/promela-formatter.py"
]], false) -- init.lua
